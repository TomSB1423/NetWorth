    ...
    return (
        <div className="min-h-screen bg-slate-950 overflow-x-hidden relative">
            ...
            <section className="relative pt-24 pb-16 px-6">
                <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-gradient-to-br from-emerald-500/15 via-blue-500/8 to-transparent rounded-full blur-3xl"></div>
                <div className="max-w-[1200px] mx-auto relative">
                    <div className="max-w-4xl">
                        ...
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.95] mb-4 text-white">
                            Know your
                            <br />
                        ...
                        <p className="text-lg md:text-xl text-slate-400 max-w-2xl mb-6 leading-snug">
            ...
            <section className="py-16 px-6 relative">
                <div className="max-w-[1200px] mx-auto relative">
                    <div className="mb-8">
                        <h2 className="text-3xl md:text-4xl font-black tracking-tighter mb-2 text-white">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-16 gap-y-8 max-w-5xl">
                        <div className="flex gap-4 pb-8 border-b border-slate-800/50">
            ...
            <section className="py-16 px-6 relative">
                <div className="max-w-[1200px] mx-auto relative">
                    <div className="border border-slate-800/50 rounded-xl p-8 md:p-12 bg-slate-900/30">
                        <div className="max-w-3xl mx-auto">
                            <h2 className="text-3xl md:text-4xl font-black tracking-tighter mb-3 text-white">
                                The wealth formula is simple
                            </h2>
                            <div className="my-6 py-6 px-6 rounded-lg bg-slate-950/50 border border-slate-800">
                ...
                <div className="max-w-[1200px] mx-auto">
                    <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
                        <div>
                            ...
                            <div className="space-y-6 border-l-2 border-slate-800/50 pl-6">
                                <div>
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 via-blue-500/10 to-emerald-500/10 rounded-xl blur-2xl"></div>
                            <div className="relative rounded-xl bg-slate-900 border border-slate-800/50 p-8 min-h-[320px] flex items-center justify-center">
                                <div className="text-center">
                                    <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-emerald-500 via-blue-500 to-emerald-500 flex items-center justify-center mx-auto mb-6">
                                        <LineChart
                                            size={40}
                                    ...
                                    <div className="space-y-2.5">
                                        <div className="h-2 bg-emerald-500/20 rounded-full w-3/4 mx-auto"></div>
                                        <div className="h-2 bg-blue-500/20 rounded-full w-1/2 mx-auto"></div>
                                        <div className="h-2 bg-emerald-500/20 rounded-full w-5/6 mx-auto"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-[1200px] mx-auto relative">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-8">
                            <div className="p-5 rounded-lg bg-slate-900/30 border border-slate-800/50">
                                <div className="text-3xl font-black text-emerald-400 mb-1.5">
                                    £847
                                </div>
                            ...
                            <div className="p-5 rounded-lg bg-slate-900/30 border border-slate-800/50">
                                <div className="text-3xl font-black text-blue-400 mb-1.5">
                                    32%
                                </div>
                                <p className="text-xs text-slate-400">
                        ...
                        <button
                            onClick={onGetStarted}
                            className="h-11 px-6 text-sm font-bold bg-gradient-to-r from-emerald-500 to-blue-500 hover:opacity-90 transition-opacity text-white rounded-lg flex items-center"
                        >
            ...
            {/* Footer */}
            <footer className="py-12 px-6 border-t border-slate-800/50 bg-slate-900/20">
                <div className="max-w-[1200px] mx-auto">

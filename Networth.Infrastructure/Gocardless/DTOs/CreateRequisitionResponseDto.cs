...
/// <summary>
///     Response DTO for a created requisition from GoCardless according to Requisition schema.
/// </summary>
internal record CreateRequisitionResponseDto
{
    /// <summary>
    ...
    /// <summary>
    ///     Gets a value indicating whether gets the account selection flag.
    /// </summary>
    [JsonPropertyName("account_selection")]
    public bool AccountSelection { get; init; } = false;

    /// <summary>
    ///     Gets a value indicating whether gets the redirect immediate flag.
    /// </summary>
